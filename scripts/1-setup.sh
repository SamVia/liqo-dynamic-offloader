...
echo -e "\033[1;32m Step 1: Creating local and remote Kind clusters...\033[0m"
...
echo -e "\033[1;32mWaiting for Liqo virtual node to be created by the controller...\033[0m"
